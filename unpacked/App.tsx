...
const CROP_NOTES = {
  '番茄': ['著果適溫 20-28℃', '高畦深耕排水要順暢', '忽乾忽濕易生尻腐病', '防銀葉粉蝨與晚疫病'],
  '牛蕃茄': ['著果適溫 20-28℃', '高畦深耕排水要順暢', '忽乾忽濕易生尻腐病', '防銀葉粉蝨與晚疫病'],
  '水蜜桃': ['拉拉山高冷地最合適', '冬季低溫足才會開花', '土層深厚忌積水悶根', '套袋防果實蠅與鳥害'],
  '稻米': ['淺水 3-5 公分促分蘗', '分蘗盛期後曬田壯根', '幼穗形成期補施穗肥', '梅雨期防稻熱病褐飛蝨'],
  '水稻': ['淺水 3-5 公分促分蘗', '分蘗盛期後曬田壯根', '幼穗形成期補施穗肥', '梅雨期防稻熱病褐飛蝨'],
  '綠竹筍': ['每叢留母竹 3-4 支', '春雨後培土筍白嫩', '筍尖見光變苦要早採', '防治竹螟與筍夜蛾'],
  '哈密瓜': ['日夜溫差大糖度才高', '一株留一果品質最佳', '採收前一週停水增甜', '防蔓枯病與銀葉粉蝨'],
  '哈蜜瓜': ['日夜溫差大糖度才高', '一株留一果品質最佳', '採收前一週停水增甜', '防蔓枯病與銀葉粉蝨'],
  '茶葉': ['山坡地排水好溫差大', '酸性土 pH 4.5-5.5 最適', '手採一心二葉品質佳', '夏季防小綠葉蟬危害'],
  '包種茶': ['青心烏龍為主力品種', '手採一心二葉最理想', '輕發酵烘焙帶清花香', '春冬兩季茶菁最優質'],
  '柚子': ['文旦白露前後採最香', '土層深厚排水忌積水', '新葉期防潛葉蛾木蝨', '採後辭水一週更香甜'],
  '甘藍-初秋': ['初秋品種早生較耐熱', '涼爽 18-22℃ 結球最好', '定植三週追第一次肥', '防小菜蛾與紋白蝶'],
  '甘藍': ['涼爽氣候 18-22℃ 為佳', '定植三週追第一次肥', '結球期供水要均勻', '連作易發根瘤病宜輪作'],
  '包心白': ['結球適溫 15-20℃ 最好', '包心期水分不能中斷', '缺鈣容易發生乾燒心', '防治小菜蛾與紋白蝶'],
  '青蔥-粉蔥': ['粉蔥較耐熱耐雨好種', '高畦排水雨後快退水', '分次培土蔥白才漂亮', '防甜菜夜蛾與蔥薊馬'],
  '青蔥': ['喜冷涼不耐高溫多雨', '高畦排水雨後要退水', '分次培土蔥白才長', '防甜菜夜蛾與蔥薊馬'],
  '山藥': ['種薯切塊癒傷後再種', '土層深厚疏鬆忌積水', '立支架通風可減病害', '防治炭疽病與根結線蟲'],
  '甜柿': ['主力品種富有與次郎', '高冷地溫差大著色好', '疏果留單果果形較大', '幼果期套袋防果實蠅'],
  '草莓': ['豐香香水是主流品種', '冷涼 15-20℃ 著色好', '高畦覆蓋果實不沾土', '防灰黴病與二點葉蟎'],
  '梨': ['低海拔以橫山梨高接', '梨穗冬季高接最合時', '疏果留端正果實較大', '防治梨木蝨與黑星病'],
  '葡萄': ['巨峰為主力栽培品種', '產期調節一年可兩收', '轉色後控水糖度才高', '雨季防露菌病與晚腐病'],
  '香蕉': ['北蕉為主力栽培品種', '立支柱防強風倒伏', '抽穗後斷蕾並套袋', '黃葉病無藥宜用健康苗'],
  '大蒜': ['冷涼 13-20℃ 生長最好', '秋分後播種較為適合', '採收前兩週停止灌水', '注意蔥薊馬與葉枯病'],
  '鳳梨': ['金鑽為市場主力品種', '高畦排水積水易爛根', '夏季戴帽防果實日燒', '雨後積水易發心腐病'],
  '芒果': ['愛文金煌為主力品種', '花期怕下雨也怕寒流', '幼果期套袋防果實蠅', '花期雨後注意炭疽病'],
  '芭樂': ['珍珠芭樂為市場主流', '修剪促新梢才會結果', '幼果套袋防東方果實蠅', '雨季注意炭疽病蔓延'],
  '洋蔥': ['冷涼 15-20℃ 結球最好', '要選短日照品種栽培', '採收前兩週停止灌水', '防治薊馬與軟腐病'],
  '西瓜': ['砂質地排水好瓜較甜', '嫁接苗能防蔓割病', '一株留 1-2 果最優質', '防瓜實蠅與蔓枯病'],
  '大西瓜': ['砂質地排水好瓜較甜', '嫁接苗能防蔓割病', '一株留 1-2 果最優質', '防瓜實蠅與蔓枯病'],
  '釋迦': ['大目與鳳梨釋迦為主', '人工授粉著果較整齊', '修剪控梢可調節產期', '注意粉介殼蟲與果實蠅'],
  '蜂蜜': ['龍眼與荔枝蜜為大宗', '春季 3-5 月為採蜜期', '蜂場需遠離噴藥果園', '花期遇雨會大幅減產'],
  '黑豬肉': ['桃園豬是本土黑豬種', '飼養約十個月以上', '豬舍通風清潔最要緊', '疑似疫病立即通報'],
  '石門活魚': ['大頭鰱與草魚最常見', '一魚多吃是招牌做法', '沿石門水庫周邊聚集', '假日用餐建議先訂位'],
  '香菇': ['太空包栽培為主流', '出菇適溫 15-22℃', '菇寮要保濕也要通風', '採後冷藏保存風味佳'],
  '韭菜': ['大溪是韭菜主要產地', '割收後追肥促再生', '遮光軟化可養出韭黃', '注意韭蛆與銹病防治'],
  '茭白筍': ['水田水位要常保穩定', '夏秋兩季為主要產期', '筍肉黑點是共生菌', '防治福壽螺與葉枯病'],
  '竹筍': ['桂竹筍春採綠竹筍夏採', '母竹留 3-4 支不擁擠', '見光轉苦要趁早採收', '防治竹螟與筍夜蛾'],
  '有機水耕蔬菜': ['溫室栽培少受天候影響', '養液濃度酸鹼要顧好', '水溫太高根部易缺氧', '管路定期清洗防藻類'],
  '桃映紅茶': ['小葉種紅茶滋味甘醇', '夏季茶菁製紅茶最適', '萎凋揉捻發酵是關鍵', '沖泡水溫 90-95℃ 為宜'],
  '東方美人茶': ['青心大冇是主要品種', '芒種前後夏茶最上等', '不噴藥才有小綠葉蟬', '重萎凋發酵帶蜜果香'],
};
...
const Page = ({selected, cropOverride, onSelect, onCropSelect, onCountyCropChange}) => {
  ...
  return (
    <div style={{
      ...
      {/* (2) 縣市名 — sits right beside the baked pin icon at design (~1030, 122).
