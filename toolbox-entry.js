...
(function () {
  var CROPS = ['番茄', '牛蕃茄', '水蜜桃', '甜柿', '綠竹筍', '竹筍', '哈密瓜', '哈蜜瓜', '包心白', '甘藍-初秋', '青蔥-粉蔥', '柚子', '文旦', '茶葉', '包種茶', '稻米', '水稻', '青蔥', '大蒜', '洋蔥', '山藥', '梨', '西瓜', '大西瓜', '芒果', '芭樂', '草莓', '葡萄', '釋迦', '香蕉', '鳳梨', '蓮藕', '茭白筍', '韭菜', '香菇', '蜂蜜', '黑豬肉', '石門活魚', '桃映紅茶', '東方美人茶', '有機水耕蔬菜'];
